...
import com.DAA.graph.scc.*;
import com.DAA.graph.topo.*;
import com.DAA.graph.dagsp.*;
import com.DAA.utils.InputReader;
import com.DAA.utils.InputReader.GraphData;
...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<GraphData> sparseGraphs = InputReader.loadAllGraphs("data/in_sparse_graphs.json");
            for (GraphData gd : sparseGraphs) {
                JsonObject graphResult = processGraph(gd, csvData);
                sparseResults.add(graphResult);
            }

            List<GraphData> denseGraphs = InputReader.loadAllGraphs("data/in_dense_graphs.json");
    ...
    private static void warmupJIT() {
        try {
            List<GraphData> warmupGraphs = InputReader.loadAllGraphs("data/in_dense_graphs.json");
